        ...
        <div className="grid grid-cols-2 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              id="firstName"
              name="firstName"
              className={`border focus:outline-none sm:text-sm rounded-md ${
                errors.firstName ? "border-red-500" : "border-gray-300"
              } block w-full px-2 py-1 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50`}
