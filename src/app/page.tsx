...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <div className="flex-1 relative bg-customBlue flex justify-center items-center">
        ...
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-customBlueDark via-transparent to-transparent"></div>
      </div>
      <Footer />
    </div>
  );
